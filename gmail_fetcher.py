...
from gemini_int import parse_expense, safe_parse_expense
...
def update_category_totals(uid, expense):
    ...
    try:
        ...
        # Convert to YYYY-MM
        month_key = expense_date.split()[0]  # "2025-09-21 16:32" -> "2025-09-21"
        month_key = datetime.strptime(month_key, "%Y-%m-%d").strftime("%Y-%m")
    ...
    for user_doc in users:
        ...
        try:
            ...
            for msg in messages:
                ...
                parsed_expense = safe_parse_expense(uid,full_body)
...
# At the bottom of gmail_fetcher.py
